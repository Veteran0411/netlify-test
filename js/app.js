...
class View{
    ...
    bindConvert(handler){
        this.convertBtn.addEventListener('click',()=>{ 
            // if i write normal function then it will be refering to button,
            // but  arrow function it will refer this to where it has been defined i.e defined of this.tempInput
...
class Controller{
    ...
    handleConversion(value,direction){
        ...
        const result=this.model.convert(value,direction);
